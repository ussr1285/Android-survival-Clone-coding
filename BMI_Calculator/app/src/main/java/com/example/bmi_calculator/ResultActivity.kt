...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when{
            bmi >= 35 -> resultTextView.setText("고도 비만")
            bmi >= 30 -> resultTextView.setText("2단계 비만")
            bmi >= 25 -> resultTextView.setText("1단계 비만")
            bmi >= 23 -> resultTextView.setText("과체중")
            bmi >= 18.5 -> resultTextView.setText("정상")
            else -> resultTextView.setText("저체중")
        }
